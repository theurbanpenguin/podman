window.addEventListener('mousemove', (event) => {
  ...
  if(menu.style.display == 'block') {
    ...
    if (event.pageX > menu_left_pos - edge_padding && event.pageY > menu_top_pos - top_spacer - edge_padding && event.pageX < menu_left_pos + menu_width + edge_padding && event.pageY < menu_top_pos + menu_height + edge_padding) {
...
shop_menu_div.addEventListener('mouseover',(event) => {
  let menu = document.getElementById('hover-menu')
