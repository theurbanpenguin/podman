...
document.querySelector('.carousel-button-1').addEventListener('click', (event) => {
...
document.querySelector('.carousel-button-2').addEventListener('click', (event) => {
...
document.querySelector('.carousel-button-3').addEventListener('click', (event) => {
